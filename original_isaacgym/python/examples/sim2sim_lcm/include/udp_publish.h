...
public:
    ...
    bool moveToInitPos(_msg_request request); // 新增：移动到初始角度
    ...
    float init_pos[10] = {0.0, -0.07, 0.57, -1.12, 0.56, 0.0, 0.07, 0.57, -1.12, 0.56}; // 初始角度
    ...
    float init_pos_tolerance = 0.05; // 初始角度误差容忍度（弧度）
