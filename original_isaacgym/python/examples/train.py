...
from configs.tinker_constraint_stand import TinkerConstraintStandRoughCfg, TinkerConstraintStandRoughCfgPPO
import isaacgym
from utils.helpers import get_args
from envs import LeggedRobot,LeggedRobot4,LeggedRobotStand
...
if __name__ == '__main__':
    ...
    task_registry.register("Tinymal",LeggedRobot4,TinymalConstraintHimRoughCfg(),TinymalConstraintHimRoughCfgPPO())
    task_registry.register("Tinker",LeggedRobot,TinkerConstraintHimRoughCfg(),TinkerConstraintHimRoughCfgPPO())
    task_registry.register("TinkerStand",LeggedRobotStand,TinkerConstraintStandRoughCfg(),TinkerConstraintStandRoughCfgPPO())
